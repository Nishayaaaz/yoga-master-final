...
export const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                path: "class/:id",
                element: <SingleClass/>,
                loader: ({ params }) => fetch(`https://yoga-master-server1-hfle.onrender.com/class/${params.id}`),
            }
        ]
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://yoga-master-server1-hfle.onrender.com/users/${params.id}`),
            },
            {
                path: 'admin-home',
